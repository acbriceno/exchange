...
const cancelWithdrawal = async (parent, args, context, info) => {
  try {
    	...
    	console.log(walletCase)
			...
			const cancelledWithdrawal = await DBGQLConnector.dbUpdateOne("TRANSACTION", "_id", ObjectID(args.transactionID), transactionPayload, context)
			
			if(cancelledWithdrawal !=null) {return true}
			return false
...
module.exports = cancelWithdrawal
